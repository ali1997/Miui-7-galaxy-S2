...
.method public initAndLoop()V
    ...
    .line 125
    .local v138, "shutdownAction":Ljava/lang/String;
    if-eqz v138, :cond_0
    ...
    .line 161
    .local v137, "serviceDiscovery":Lcom/android/server/NsdService;
    const/16 v123, 0x0
    ...
    .line 164
    .local v160, "wm":Lcom/android/server/wm/WindowManagerService;
    const/16 v70, 0x0
    ...
    .line 167
    .local v133, "rotateSwitch":Lcom/android/server/RotationSwitchObserver;
    const/16 v149, 0x0
    ...
    new-instance v161, Landroid/os/HandlerThread;
    ...
    .line 180
    .local v161, "wmHandlerThread":Landroid/os/HandlerThread;
    invoke-virtual/range {v161 .. v161}, Landroid/os/HandlerThread;->start()V

    .line 181
    new-instance v21, Landroid/os/Handler;

    invoke-virtual/range {v161 .. v161}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;
    ...
    :try_end_3
    .catch Ljava/lang/RuntimeException; {:try_start_3 .. :try_end_3} :catch_56
    ...
    :try_end_4
    .catch Ljava/lang/RuntimeException; {:try_start_4 .. :try_end_4} :catch_57
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_9
    .catch Ljava/lang/Throwable; {:try_start_9 .. :try_end_9} :catch_5f
    .catch Ljava/lang/RuntimeException; {:try_start_9 .. :try_end_9} :catch_58
    ...
    .line 303
    new-instance v152, Lcom/android/server/VibratorService;
    ...
    .local v152, "vibrator":Lcom/android/server/VibratorService;
    :try_start_d
    ...
    :try_end_d
    .catch Ljava/lang/RuntimeException; {:try_start_d .. :try_end_d} :catch_5b
    ...
    :try_end_e
    .catch Ljava/lang/RuntimeException; {:try_start_e .. :try_end_e} :catch_5c
    ...
    :try_end_f
    .catch Ljava/lang/RuntimeException; {:try_start_f .. :try_end_f} :catch_5d
    ...
    .line 337
    invoke-virtual/range {v160 .. v160}, Lcom/android/server/wm/WindowManagerService;->getInputMonitor()Lcom/android/server/wm/InputMonitor;
    ...
    .end local v152    # "vibrator":Lcom/android/server/VibratorService;
    ...
    .line 373
    .local v127, "profile":Lcom/android/server/ProfileManagerService;
    const/16 v121, 0x0
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_12
    .catch Ljava/lang/Throwable; {:try_start_12 .. :try_end_12} :catch_55
    ...
    :goto_e
    :try_start_14
    invoke-virtual/range {v160 .. v160}, Lcom/android/server/wm/WindowManagerService;->displayReady()V
    :try_end_14
    ...
    :try_end_16
    .catch Landroid/os/RemoteException; {:try_start_16 .. :try_end_16} :catch_54
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_18
    .catch Ljava/lang/Throwable; {:try_start_18 .. :try_end_18} :catch_53
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_1a
    .catch Ljava/lang/Throwable; {:try_start_1a .. :try_end_1a} :catch_52
    ...
    .line 462
    new-instance v140, Lcom/android/server/StatusBarManagerService;
    ...
    .line 492
    new-instance v144, Lcom/android/server/TextServicesManagerService;
    ...
    .line 520
    new-instance v159, Landroid/net/wifi/p2p/WifiP2pService;
    ...
    .local v159, "wifiP2p":Landroid/net/wifi/p2p/WifiP2pService;
    :try_start_28
    ...
    .line 527
    .end local v159    # "wifiP2p":Landroid/net/wifi/p2p/WifiP2pService;
    ...
    .line 528
    new-instance v157, Lcom/android/server/wifi/WifiService;
    ...
    .local v157, "wifi":Lcom/android/server/wifi/WifiService;
    :try_start_2a
    ...
    .line 535
    .end local v157    # "wifi":Lcom/android/server/wifi/WifiService;
    ...
    .line 542
    invoke-virtual/range {v158 .. v158}, Landroid/net/wifi/p2p/WifiP2pService;->connectivityServiceReady()V

    .line 543
    invoke-virtual/range {v156 .. v156}, Lcom/android/server/wifi/WifiService;->checkAndStartWifi()V
    :try_end_2c
    ...
    .line 593
    new-instance v128, Lcom/android/server/ProfileManagerService;
    ...
    .line 594
    .end local v127    # "profile":Lcom/android/server/ProfileManagerService;
    .local v128, "profile":Lcom/android/server/ProfileManagerService;
    :try_start_32
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_32
    .catch Ljava/lang/Throwable; {:try_start_32 .. :try_end_32} :catch_49

    move-object/from16 v127, v128

    .line 600
    .end local v128    # "profile":Lcom/android/server/ProfileManagerService;
    .restart local v127    # "profile":Lcom/android/server/ProfileManagerService;
    :goto_22
    :try_start_33
    const-string v7, "SystemServer"
    ...
    .line 699
    new-instance v134, Lcom/android/server/RotationSwitchObserver;
    ...
    .end local v133    # "rotateSwitch":Lcom/android/server/RotationSwitchObserver;
    .local v134, "rotateSwitch":Lcom/android/server/RotationSwitchObserver;
    move-object/from16 v133, v134

    .line 705
    .end local v134    # "rotateSwitch":Lcom/android/server/RotationSwitchObserver;
    .restart local v133    # "rotateSwitch":Lcom/android/server/RotationSwitchObserver;
    :cond_14
    :goto_2d
    if-nez v89, :cond_15
    ...
    .line 709
    new-instance v150, Lcom/android/server/usb/UsbService;
    ...
    .local v150, "usb":Lcom/android/server/usb/UsbService;
    :try_start_43
    const-string v7, "usb"
    ...
    .line 716
    .end local v150    # "usb":Lcom/android/server/usb/UsbService;
    ...
    .line 718
    new-instance v136, Lcom/android/server/SerialService;
    ...
    .line 727
    new-instance v146, Lcom/android/server/TwilightService;
    ...
    .restart local v145    # "twilight":Lcom/android/server/TwilightService;
    :goto_30
    :try_start_47
    const-string v7, "SystemServer"
    ...
    .line 735
    new-instance v148, Lcom/android/server/UiModeManagerService;
    ...
    .local v148, "uiMode":Lcom/android/server/UiModeManagerService;
    move-object/from16 v147, v148

    .line 740
    .end local v148    # "uiMode":Lcom/android/server/UiModeManagerService;
    .restart local v147    # "uiMode":Lcom/android/server/UiModeManagerService;
    :goto_31
    if-nez v89, :cond_16
    ...
    .line 868
    invoke-virtual/range {v160 .. v160}, Lcom/android/server/wm/WindowManagerService;->detectSafeMode()Z
    ...
    :goto_3f
    :try_start_5a
    invoke-virtual/range {v151 .. v151}, Lcom/android/server/VibratorService;->systemReady()V
    :try_end_5a
    ...
    .line 925
    :cond_1f
    invoke-virtual/range {v160 .. v160}, Lcom/android/server/wm/WindowManagerService;->computeNewConfiguration()Landroid/content/res/Configuration;
    ...
    .line 949
    :goto_47
    new-instance v101, Landroid/content/IntentFilter;

    invoke-direct/range {v101 .. v101}, Landroid/content/IntentFilter;-><init>()V
    ...
    invoke-direct/range {v31 .. v61}, Lcom/android/server/ServerThread$2;-><init>(Lcom/android/server/ServerThread;ZLandroid/content/Context;Lcom/android/server/MountService;Lcom/android/server/BatteryService;Lcom/android/server/NetworkManagementService;Lcom/android/server/net/NetworkStatsService;Lcom/android/server/net/NetworkPolicyManagerService;Lcom/android/server/ConnectivityService;Lcom/android/server/DockObserver;Lcom/android/server/RotationSwitchObserver;Lcom/android/server/usb/UsbService;Lcom/android/server/TwilightService;Lcom/android/server/UiModeManagerService;Lcom/android/server/RecognitionManagerService;Lcom/android/server/AppWidgetService;ZLcom/android/server/WallpaperManagerService;Lcom/android/server/InputMethodManagerService;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LocationManagerService;Lcom/android/server/CountryDetectorService;Lcom/android/server/NetworkTimeUpdateService;Lcom/android/server/CommonTimeManagementService;Lcom/android/server/TextServicesManagerService;Lcom/android/server/dreams/DreamManagerService;Lcom/android/server/AssetAtlasService;Lcom/android/server/input/InputManagerService;Lcom/android/server/TelephonyRegistry;Lcom/android/server/print/PrintManagerService;)V
    ...
    .end local v103    # "hasRotationLock":Z
    .end local v104    # "imm":Lcom/android/server/InputMethodManagerService;
    .end local v107    # "installer":Lcom/android/server/pm/Installer;
    .end local v110    # "location":Lcom/android/server/LocationManagerService;
    .end local v112    # "lockSettings":Lcom/android/server/LockSettingsService;
    ...
    .end local v133    # "rotateSwitch":Lcom/android/server/RotationSwitchObserver;
    .end local v135    # "serial":Lcom/android/server/SerialService;
    .end local v137    # "serviceDiscovery":Lcom/android/server/NsdService;
    .end local v139    # "statusBar":Lcom/android/server/StatusBarManagerService;
    .end local v141    # "telephonyRegistry":Lcom/android/server/TelephonyRegistry;
    .end local v143    # "tsms":Lcom/android/server/TextServicesManagerService;
    .end local v145    # "twilight":Lcom/android/server/TwilightService;
    ...
    .end local v156    # "wifi":Lcom/android/server/wifi/WifiService;
    .end local v158    # "wifiP2p":Landroid/net/wifi/p2p/WifiP2pService;
    .end local v160    # "wm":Lcom/android/server/wm/WindowManagerService;
    .end local v161    # "wmHandlerThread":Landroid/os/HandlerThread;
    :cond_21
    const/16 v130, 0x0
    ...
    .restart local v133    # "rotateSwitch":Lcom/android/server/RotationSwitchObserver;
    .restart local v135    # "serial":Lcom/android/server/SerialService;
    .restart local v137    # "serviceDiscovery":Lcom/android/server/NsdService;
    .restart local v141    # "telephonyRegistry":Lcom/android/server/TelephonyRegistry;
    .restart local v145    # "twilight":Lcom/android/server/TwilightService;
    .restart local v147    # "uiMode":Lcom/android/server/UiModeManagerService;
    .restart local v149    # "usb":Lcom/android/server/usb/UsbService;
    ...
    .restart local v156    # "wifi":Lcom/android/server/wifi/WifiService;
    .restart local v158    # "wifiP2p":Landroid/net/wifi/p2p/WifiP2pService;
    .restart local v160    # "wm":Lcom/android/server/wm/WindowManagerService;
    .restart local v161    # "wmHandlerThread":Landroid/os/HandlerThread;
    :catch_0
    move-exception v98
    ...
    .restart local v152    # "vibrator":Lcom/android/server/VibratorService;
    :cond_27
    const/16 v22, 0x0
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_64
    .catch Ljava/lang/RuntimeException; {:try_start_64 .. :try_end_64} :catch_5e
    ...
    .restart local v83    # "devicePolicy":Lcom/android/server/DevicePolicyManagerService;
    .restart local v96    # "dreamy":Lcom/android/server/dreams/DreamManagerService;
    .restart local v103    # "hasRotationLock":Z
    .restart local v104    # "imm":Lcom/android/server/InputMethodManagerService;
    .restart local v110    # "location":Lcom/android/server/LocationManagerService;
    .restart local v112    # "lockSettings":Lcom/android/server/LockSettingsService;
    .restart local v121    # "notification":Lcom/android/server/NotificationManagerService;
    ...
    .line 711
    .end local v149    # "usb":Lcom/android/server/usb/UsbService;
    .restart local v150    # "usb":Lcom/android/server/usb/UsbService;
    :catch_44
    move-exception v98
    ...
    .line 595
    .end local v127    # "profile":Lcom/android/server/ProfileManagerService;
    .restart local v128    # "profile":Lcom/android/server/ProfileManagerService;
    :catch_49
    move-exception v98
    ...
    .line 530
    .end local v156    # "wifi":Lcom/android/server/wifi/WifiService;
    .restart local v157    # "wifi":Lcom/android/server/wifi/WifiService;
    :catch_4b
    move-exception v98
    ...
    .line 522
    .end local v158    # "wifiP2p":Landroid/net/wifi/p2p/WifiP2pService;
    .restart local v159    # "wifiP2p":Landroid/net/wifi/p2p/WifiP2pService;
    :catch_4c
    move-exception v98
